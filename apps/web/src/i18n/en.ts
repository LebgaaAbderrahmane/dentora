export const en = {
  ...
  why: {
    label: 'Why Choose Us',
    title: 'Are you looking for a dentist to give you that special smile?',
    body: 'Dentora Clinic provides the highest quality dental care in Algiers with a team of experienced dentists and specialists.',
    items: [
      'Dental check-ups',
      'Hygiene treatments',
  ...
  testimonials: {
    ...
    subline: '★★★★★ 4.9 average from 1,200+ verified reviews',
    list: [
      {
        quote:
  ...
  photoCta: {
    ...
    body: 'Same-day appointments available. No waiting lists.',
    cta: 'Book Appointment',
  ...
  cta: {
    ...
    body: 'Request a free consultation in under 2 minutes. Same-day appointments available. Transparent pricing, no surprises.',
    cta: 'Book Free Consultation',
    trust: ['No waiting list', 'Transparent pricing', 'All ages welcome'],
  },
  footer: {
    tagline: "Your Family's Dental Clinic",
    ...
    clinicLinks: ['About Us', 'Meet the Team', 'Patient Reviews', 'Blog', 'Careers'],
    hours: ['Sun – Thu: 8:30am – 6:30pm', 'Saturday: 9:00am – 1:00pm', 'Friday: Closed'],
    emergency: '24/7 Emergency:',
    copyright: '© {{year}} Dentora Dental Clinic. All rights reserved.',
